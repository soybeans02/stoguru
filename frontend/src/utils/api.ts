...
// ─── 投稿申請ゲートは廃止 ───
// 旧 /influencer/upload-application（GET/POST）と /admin/upload-applications
// 系のクライアントヘルパーは全て撤廃した。認証済みユーザーは申請なしで
// 直接 InfluencerDashboard から投稿できる。バックエンドも requireAuth のみ。
