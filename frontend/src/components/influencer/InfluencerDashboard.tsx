...
import { localizeGenre, localizeProperNoun, localizePriceRange } from '../../utils/labelI18n';
          ...
          {sortedRestaurants.map(r => (
            <div key={r.restaurantId} className="bg-white rounded-xl overflow-hidden shadow border border-gray-100 flex flex-col">
              ...
              <div className="px-2.5 py-2">
                <h3 className="text-[13px] font-bold text-gray-900 truncate">{localizeProperNoun(r.name, language)}</h3>
                {r.priceRange && <p className="text-[11px] text-gray-400 truncate">{localizePriceRange(r.priceRange, language)}</p>}
